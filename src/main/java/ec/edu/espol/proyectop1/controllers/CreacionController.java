   ...
   public void setUsuarioCreacion(Usuario usuario) {
    ...
    private void registratVehiculo(MouseEvent event) {
        ...
        try{
            ...
            boolean placaExistente = Vehiculo.validarPlacaExistente(pl, "vehiculos.ser");
            ...
            if ("Auto".equals(seleccion)) {
                ...
                Auto auto = new Auto(userId, pl, marc, model, motor, ano, reco, col, combust, vidrio, transmision, price);
                ...
                if (!traccion.isEmpty()) {
                    ...
                    Camioneta camioneta = new Camioneta(userId,pl, marc, model, motor, ano, reco, col, combust, vidrio, transmision,price,traccion);
